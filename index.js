...
Do you follow it, or continue on your path?`)
    ...
    to this magical safe haven.`)
        ...
        window.prompt(`You come across a chamber that reaches upward to a shining light 
    above. There is a long, winding staircase, and a much quicker, but rickety-looking 
    ladder that leads up toward the light. Which do you take?`)    
    }
            if (thirdAnswer === 'ladder') {
                window.alert(`After ascending a few feet up the ladder, one of its rungs 
            snaps, and you comedically fall through each of the rungs below. Sheepish, you 
            return home.`)
...
lead you away from the dragon altogether. Which path do you take?`)
    ...
    You only have a moment to respond, to stay or run:`)
        if (thirdAnswer === 'stay') {
            ...
            window.alert(`Quickly, you run back to the cave's entrance. Sheepish, you 
        return home.`)
        }
    } else if (secondAnswer === `Away from the dragon`) {
        window.prompt(`After walking a while longer, you come across a shiny blue flower. 
        It is so beautiful that you decide you must either draw it or pick it. Which do 
        you do?`)    
    }
        if (thirdAnswer === 'Draw it') {
            window.prompt(`You draw the flower, capturing only a fraction of its beauty with 
        your quill. You bring the drawing home, somewhat disappointed, but over time, 
        discover joy in sharing it with your friends and family, recounting the story of 
        your days as a sorcerer with the aid of the sketch.`)
